...
Overview 不能回流旧活动矩阵、mini chart wall 或 chart matrix；页面必须保留 hero next action、四段管线、阻塞优先级、readiness switchboard、一个 operations surface 和最近 run 紧凑摘要组成的 command desk，
