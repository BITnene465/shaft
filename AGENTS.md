...
- 新增能力必须同步更新 `docs/`，且至少在以下文档之一落地：`docs/architecture.md`、`docs/module_reference.md`、`docs/extension_guide.md`、`docs/config_reference.md`、`docs/online_eval_design.md`。
